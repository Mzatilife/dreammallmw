...
if (isset($_POST['submit'])) {
    ...
    if ($check > 0) {
        $msg2 = "Error, You can't register another business with this account!";
    } else {
        ...
        if (in_array($file_extension, $valid_ext)) {
            ...
            $result = $shop->registerBusiness($user_id, $district, $name, $type, $area, $opent, $closet, $days, $address, $phone, $phone2, $email, $url, $new_name, $fb, $ig, $twitter, $app);
            if ($result) {
                $msg = "Business/shop registered";
                // header("refresh:4, url=register_shop.php");
            } else {
                $msg2 = "Error, couldn't register business/shop";
            }
        } else {
                    ...
                    <div class="col-md-12">
                        <div class="card shadow mb-4">
                            <div class="card-header">
                                <strong class="card-title">Register Shop | Business</strong>
                            </div>
                            <div class="card-body">
                                <?php
                                if (isset($msg)) { ?>
                                ...
                                <form class="needs-validation" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="POST" enctype="multipart/form-data" novalidate>
                                    <div class="form-row">
                                        <div class="col-md-6 mb-3">
                                            <label for="validationCustom3">Shop name <span class="text-danger">*</span></label>
                                            <input type="text" class="form-control required" name="name" id="validationCustom3" placeholder="Nike" required>
                                    ...
                                    <div class="form-row">
                                        ...
                                        <div class="col-md-3 mb-3">
                                            ...
                                            <input type="text" class="form-control required" name="area" id="validationCustom33" required>
                                            <div class="valid-feedback"> Looks good! </div>
                                        ...
                                        <div class="col-md-6 mb-3">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="number" name="address" class="form-control" id="quantity">
                                                <div class="valid-feedback"> Looks good! </div>
                                            </div>
                                        </div>
                                    </div> <!-- /.form-row -->
                                    <div class="form-row">
                                        <div class="col-md-3 mb-3">
                                            <label for="validationSelect2">Opening Time <span class="text-danger">*</span></label>
                                            <input type="time" class="form-control required" name="opent" id="validationCustom33" required>
                                            <div class="valid-feedback"> Looks good! </div>
                                            <div class="invalid-feedback"> Please enter valid district </div>
                                        </div>
                                        <div class="col-md-3 mb-3">
                                            <label for="validationCustom33">Closing Time <span class="text-danger">*</span></label>
                                            <input type="time" class="form-control required" name="closet" id="validationCustom33" required>
                                            <div class="valid-feedback"> Looks good! </div>
                                            <div class="invalid-feedback"> Please provide a valid area </div>
                                        </div>
                                        <div class="col-md-6 mb-3">
                                            <label for="quantity">Opening Days <span class="text-danger">*</span></label>
                                    ...
                                    <div class="form-row">
                                        <div class="col-md-6 mb-3">
                                            <label for="validationCustom3">Phone <span class="text-danger">*</span></label>
                                            <input type="text" class="form-control required" name="phone" id="validationCustom3" placeholder="enter phone number" required>
                                            <div class="valid-feedback"> Looks good! </div>
                                        ...
                                        <div class="col-md-6 mb-3">
                                            ...
                                            <input type="text" class="form-control required" name="phone2" id="validationCustom3" placeholder="enter phone number">
                                            <div class="valid-feedback"> Looks good! </div>
                                        </div>
                                    </div> <!-- /.form-row -->
                                    <div class="form-row">
                                        <div class="col-md-6 mb-3">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="url" class="form-control" name="fb" id="validationCustom3" placeholder="">
                                                <div class="valid-feedback"> Looks good! </div>
                                            </div>
                                        </div>
                                        <div class="col-md-6 mb-3">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="url" class="form-control" name="ig" id="validationCustom3" placeholder="">
                                                <div class="valid-feedback"> Looks good! </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-row">
                                        <div class="col-md-6 mb-3">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="url" class="form-control" name="twitter" id="validationCustom3" placeholder="">
                                                <div class="valid-feedback"> Looks good! </div>
                                            </div>
                                        </div>
                                        <div class="col-md-6 mb-3">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="text" class="form-control" name="app" id="validationCustom3" placeholder="">
                                                <div class="valid-feedback"> Looks good! </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-row">
                                        <div class="col-md-6">
                                            <div class="mb-3">
                                                ...
                                                <input type="email" class="form-control required" name="email" id="validationCustom3" placeholder="example@company.com">
                                                <div class="valid-feedback"> Looks good! </div>
                                            </div>
                                            <div class="mb-3">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <input type="url" class="form-control required" name="url" id="validationCustom3" placeholder="https://dreamcodemw.com">
                                                    <div class="valid-feedback"> Looks good! </div>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-6 form-group mb-3">
                                            <label for="customFile">Upload Image <span class="text-danger">*</span></label>
