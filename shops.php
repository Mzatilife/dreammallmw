                ...
                <div class="accordion" id="accordionExample">
                  <div class="card">
                    <div class="card-heading active">
                      <a data-toggle="collapse" class="btn btn-primary" style="color: white;" data-target="#collapseOne">view categories <span class="fa fa-eye"></span></a>
                    </div>
                    <div id="collapseOne" class="collapse" data-parent="#accordionExample">
                      <div class="card-body">
                        <ul>
                          ...
                          foreach ($cats as $cat) {
                          ?>
                            <li><a href="shops.php?cat_id=<?php echo $cat['cat_id'] ?>"><?php echo $cat['cat_name'] ?></a></li>
                          <?php } ?>
                        </ul>
                      </div>
                    </div>
        ...
        <div class="col-lg-9 col-md-9">
          <div class="row">
            ...
            if (empty($_SESSION['categories'])) {
              $row = $shop->viewRandomShopWithLimit(1, $page1, 12);
            } else {
              $category = $_SESSION['categories'];
              $row = $shop->viewRandomShopWithCat(1, $category, $page1, 12);
            }
            if (!empty($row)) {
              $index = 1;
              foreach ($row as $rw) {
              ...
              <div class="container">
                <div class="discount__text">
                  <div class="discount__text__title">
                    ...
                    <p class="mt-3">Shops or businesses might not have been registered in this category</p>
            ...
            if (empty($_SESSION['categories'])) {
              $cout = $shop->countShops(1);
            } else {
              $category = $_SESSION['categories'];
              $cout = $shop->countShopsWithCat(1, $category);
            }
            ...
            <div class="col-lg-12 text-center">
              <div class="pagination__option">
                <?php for ($b = 1; $b <= $a; $b++) {  ?>
                  <a href="shops.php?page=<?php echo $b; ?>"><?php echo $b . " "; ?></a>
                <?php } ?>
